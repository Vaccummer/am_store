...
# entry function
def initLogger(log_path:str, print_level:LogLevel=LogLevel.DEBUG, file_level:LogLevel=LogLevel.DEBUG, 
                 callback_level:LogLevel=LogLevel.DEBUG, color_config:LogConfig=LogConfig())->AmLogger:
    return get_logger(log_path, print_level, file_level, callback_level, color_config)
