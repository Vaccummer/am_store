...
class Attention(nn.Module):
    ...
    def __init__(self, d_model:int, heads_num:int, n_kv_heads:int=None, **kwargs):
        super().__init__()
        self.n_heads = heads_num
        self.n_kv_heads = heads_num if n_kv_heads is None else n_kv_heads
        self.n_rep = self.n_heads // self.n_kv_heads
        self.head_dim = d_model // heads_num

        self.wq = nn.Linear(
            d_model, heads_num * self.head_dim, bias=False
        )
        ...
        self.wo = nn.Linear(
            heads_num * self.head_dim, d_model, bias=False
        )
